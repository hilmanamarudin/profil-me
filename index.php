...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top">
        <div class="container">
            <a class="navbar-brand text-white" href="#">2203010019 Hilman Amarudin A 2022</a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <button class="btn hire-btn"><a href="mailto:2203010019@unper.ac.id"><b>Hire me</b></a></button>
                </li>
            </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 hero-content">
                    ...
                    <a href="editor/assets/cv/CV Hilman Amarudin.pdf" class="btn btn-custom" download>Download CV</a>
                </div>
    ...
    <footer class="py-4 bg-dark text-white" id="contact">
        <div class="container text-center">
            <p>Contact</p>
            <address>
                Address: Cibereum, Tasikmalaya<br>
                Jawa Barat, Indonesia
            </address>
            <div>
               <a href="https://www.instagram.com/hilmanamar_?igsh=YWl3bW1zeG5lMXY%3D&utm_source=qr" class="text-white"><i class="bi bi-instagram" target="_blank"></i> Instagram</a>
            </div>
            <p class="mt-3 mb-0">© 2024 Hilman Amarudin. All rights reserved.</p>
        </div>
    </footer>
